...
- **"Contribution"** means any original work of authorship, including
  ...
  to the Project via pull request, issue, email, or any other method.
...
distribute your Contributions and any derivative works.
...
You understand and agree that the Maintainer retains the right to offer the
Project (including your Contributions) under additional license terms beyond
AGPL-3.0, including commercial licenses. This enables the Maintainer to
sustain the Project through dual-licensing arrangements.

### 5. Original Work Representation

You represent that each Contribution is your original creation and that you
have the right to grant the licenses in this agreement. If your employer has
...
is at the sole discretion of the Maintainer. You are not expected to provide
support for your Contributions, except to the extent you desire to do so.

### 7. "As Is" Contributions

Contributions are provided "AS IS", without warranty of any kind. You are not
required to provide support, maintenance, or updates.

---

## How to Sign

By submitting a pull request to this repository, you acknowledge that you have
read and agree to this Contributor License Agreement. Your Git commit signature
(name and email) serves as your electronic signature.

If you are contributing on behalf of a company, please have an authorized
representative email matt@catsimanes.com to confirm acceptance.
