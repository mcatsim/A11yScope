...
from accessiflow.ai.prompts import SYSTEM_PROMPT, EXPLAIN_ISSUE_PROMPT, ALT_TEXT_PROMPT, LINK_TEXT_PROMPT
from accessiflow.models import AccessibilityIssue
