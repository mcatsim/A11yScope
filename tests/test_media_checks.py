...
from a11yscope.checks.pdf_check import PDFNotTagged, PDFMissingTitle, PDFMissingLanguage, PDFImageOnly
from a11yscope.checks.document_check import DocxImagesMissingAlt, PptxSlidesMissingTitles
